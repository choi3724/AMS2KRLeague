...
현재 개발 버전과 SemVer 기준은 `0.7.1`, Assembly 기준은 `0.7.1.0`입니다. 공개 GitHub Latest는 `0.7.1`입니다. `v0.2.2`는 변경하지 않는 안정 기준선입니다.
...
- 기록 전송·인증·종료 복구, HUD 처리 개선, 경기 중 업데이트 설치 보류: `0.7.1`
