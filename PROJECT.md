...
# 0.7.3 릴리즈 — RPM 자동 최대 여유 수정

레드존 위 최소1000RPM 여유를 확보하는 자동 범위 계산을0.7.3에 반영한다. 수동 최대값과90%/97% 경고 정책은 유지한다. [검증 보고서](docs/reports/2026-09-13-release-0.7.3.md). 아래는 이전 단계 이력이다.

# 미배포 수정 — RPM 자동 최대에1000RPM 여유

레드존6800→최대8000,14800→16000이 되도록 공통 자동 계산을 ceil((redStart+1000)/1000)*1000으로 수정했다. 수동 최대·90%/97% 경계·200ms 점멸/완등 유지. 최종Client158/158·Activity111/111·빌드 경고/오류0, WPF 캡처 확인. 공개0.7.2는 미변경. [보고서](docs/reports/2026-09-13-avante-rpm-headroom.md).
...
- 게임 연동 정책: **읽기 전용**
- 현재 릴리즈 버전: **v0.7.4** (게시 결과는 상단 릴리즈 보고서 참조)
- 0.7.0 안정화 작업 기준 커밋: **48b2881f1f6f4b6f758763ef9556e383db086e70**
- 현재 Assembly/File version 기준: **0.7.4 / 0.7.4.0**
