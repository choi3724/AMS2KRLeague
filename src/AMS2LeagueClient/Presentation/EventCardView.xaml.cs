...
namespace AMS2LeagueClient.Presentation
{
    public partial class EventCardView : UserControl
    {
        ...
        private void AnimateIn()
        {
            ...
            if (Panel.RenderTransform is TranslateTransform transform) transform.BeginAnimation(TranslateTransform.YProperty, new DoubleAnimation(14, 0, duration) { EasingFunction = easing });
        }
    }
}
